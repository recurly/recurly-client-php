...
final class ResponseTest extends TestCase
{
    ...
    public function testStatusCode(): void
    {
        ...
        $response->setHeaders(array($status));
        $this->assertEquals(
            $status_code,
            $response->getStatusCode()
        );
    ...
    public function testRequestIdHeader(): void
    {
        ...
        $response->setHeaders(array("X-Request-Id: {$request_id}"));
        $this->assertEquals(
            $request_id,
    ...
    public function testRateLimitHeader(): void
    {
        $response = new Response('');
        $rate_limit = "2000";
        $response->setHeaders(array("X-RateLimit-Limit: {$rate_limit}"));
        $this->assertEquals(
            $rate_limit,
    ...
    public function testRateLimitRemainingHeader(): void
    {
        ...
        $response->setHeaders(array("X-RateLimit-Remaining: {$rate_limit_remaining}"));
        $this->assertEquals(
    ...
    public function testRateLimitResetHeader(): void
    {
        ...
        $response->setHeaders(array("X-RateLimit-Reset: {$rate_limit_reset}"));
        $this->assertEquals(
            $rate_limit_reset,
    ...
    public function testContentTypeHeaderSimple(): void
    {
        ...
        $response->setHeaders(array("Content-Type: {$content_type}"));
        $this->assertEquals(
            $content_type,
    ...
    public function testContentTypeHeaderMultiPart(): void
    {
        ...
        $response->setHeaders(array("Content-Type: {$content_type}; {$charset}"));
        $this->assertEquals(
            $content_type,
            $response->getContentType()
        );
