...
class AdjustmentTest extends TestCase
{
    ...
    {
        $adjustment = Adjustment::get('abcdef1234567890', $this->client);

        $this->assertInstanceOf('Recurly\Adjustment', $adjustment);
        $this->assertInstanceOf('Recurly\Stub', $adjustment->account);
        $this->assertInstanceOf('Recurly\Stub', $adjustment->invoice);
        $this->assertInstanceOf('Recurly\Stub', $adjustment->subscription);
        ...
        $this->assertInstanceOf('Recurly\TaxDetail', $taxDetails[0]);
        $this->assertInstanceOf('Recurly\TaxDetail', $taxDetails[1]);
        /** @var TaxDetail $state */
        $state = $taxDetails[0];
        /** @var TaxDetail $county */
        $county = $taxDetails[1];
    ...
    public function testDelete()
    {
        ...
        $this->client->addResponse('DELETE', 'https://api.recurly.com/v2/adjustments/abcdef1234567890',
            'adjustments/destroy-204.xml');
