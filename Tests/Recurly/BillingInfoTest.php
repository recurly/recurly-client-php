...
class BillingInfoTest extends TestCase
{
    public function defaultResponses()
    {
        return array(
            ...
            array(
                'DELETE',
                'https://api.recurly.com/v2/accounts/abcdef1234567890/billing_info',
                'billing_info/destroy-204.xml',
            ),
        );
    }
    ...
    {
        $billing_info = BillingInfo::get('abcdef1234567890', $this->client);

        $this->assertInstanceOf('Recurly\BillingInfo', $billing_info);
        ...
        $this->assertEquals($billing_info->getHref(),
            'https://api.recurly.com/v2/accounts/abcdef1234567890/billing_info');
    }

    public function testGetPayPalBillingInfo()
    {
        $billing_info = BillingInfo::get('paypal1234567890', $this->client);
        ...
        $this->assertEquals($billing_info->getHref(),
            'https://api.recurly.com/v2/accounts/paypal1234567890/billing_info');
    }

    public function testGetAmazonBillingInfo()
    {
        $billing_info = BillingInfo::get('amazon1234567890', $this->client);
        ...
        $this->assertEquals($billing_info->getHref(),
            'https://api.recurly.com/v2/accounts/amazon1234567890/billing_info');
    }

    public function testGetBankAccountBillingInfo()
    {
        $billing_info = BillingInfo::get('bankaccount1234567890', $this->client);
        ...
        $this->assertEquals($billing_info->card_type, null);
        $this->assertEquals($billing_info->getHref(),
            'https://api.recurly.com/v2/accounts/bankaccount1234567890/billing_info');
    }
    ...
    {
        BillingInfo::deleteForAccount('abcdef1234567890', $this->client);
    }

    public function testCreateForAccount()
    {
        $billing_info = new BillingInfo(null, $this->client);
