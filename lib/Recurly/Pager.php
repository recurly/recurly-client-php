 ...
 */
abstract class Pager extends Base implements \Iterator
{
     ...
     *
     * @return int number of records in list
     */
     ...
     * The current object.
     *
     * @return resource the current object
     */
    ...
    /**
     * @return int current position within the current page
     */
    public function key()
    {
    ...
    protected function _loadFrom($uri, $params = null)
    {
        ...
        $uri = Base::_uriWithParams($uri, $params);
        $response = $this->_client->request(Client::GET, $uri);
