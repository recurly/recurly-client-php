...
class Client extends BaseClient
{
     ...
     * @param array  $options    Associative array of optional parameters
     *
     * @return \Recurly\Resources\ExternalAccountResponse A representation of the created external_account.
     * @link   https://developers.recurly.com/api/v2021-02-25#operation/create_account_external_account
     */
    public function createAccountExternalAccount(string $account_id, array $body, array $options = []): \Recurly\Resources\ExternalAccountResponse
    {
        $path = $this->interpolatePath("/accounts/{account_id}/external_accounts", ['account_id' => $account_id]);
        return $this->makeRequest('POST', $path, $body, $options);
    }
     ...
     * @param array  $options             Associative array of optional parameters
     *
     * @return \Recurly\Resources\ExternalAccountResponse A external account on an account.
     * @link   https://developers.recurly.com/api/v2021-02-25#operation/get_account_external_account
     */
    public function getAccountExternalAccount(string $account_id, string $external_account_id, array $options = []): \Recurly\Resources\ExternalAccountResponse
    {
     ...
     * @param array  $options             Associative array of optional parameters
     *
     * @return \Recurly\Resources\ExternalAccountResponse A representation of the updated external_account.
     * @link   https://developers.recurly.com/api/v2021-02-25#operation/update_account_external_account
     */
    public function updateAccountExternalAccount(string $account_id, string $external_account_id, array $body, array $options = []): \Recurly\Resources\ExternalAccountResponse
    {
        $path = $this->interpolatePath("/accounts/{account_id}/external_accounts/{external_account_id}", ['account_id' => $account_id, 'external_account_id' => $external_account_id]);
        return $this->makeRequest('PUT', $path, $body, $options);
    }
     ...
     * @param array  $options             Associative array of optional parameters
     *
     * @return \Recurly\Resources\ExternalAccountResponse Successful Delete
     * @link   https://developers.recurly.com/api/v2021-02-25#operation/deleteAccountExternalAccount
     */
    public function deleteaccountexternalaccount(string $account_id, string $external_account_id, array $options = []): \Recurly\Resources\ExternalAccountResponse
    {
        $path = $this->interpolatePath("/accounts/{account_id}/external_accounts/{external_account_id}", ['account_id' => $account_id, 'external_account_id' => $external_account_id]);
        return $this->makeRequest('DELETE', $path, [], $options);
    }
