...
class Client extends BaseClient
{
     ...
     * @link   https://developers.recurly.com/api/v2019-10-10#operation/verify_billing_info
     */
    public function verifyBillingInfo(string $account_id, array $body = []): \Recurly\Resources\Transaction
    {
     ...
     */
    public function applyCreditBalance(string $invoice_id): \Recurly\Resources\Invoice
    {
