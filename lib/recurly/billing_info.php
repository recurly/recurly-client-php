 ...
 * @property string $month Expiration month
 * @property string $year Expiration year
 ...
 * @property stringSTRONGLY RECOMMENDED $country Country, 2-letter ISO code STRONGLY RECOMMENDED
 ...
 * @property string $currency Currency in which invoices will be posted. Only applicable if this account is enrolled in a plan has a different currency than your site's default.
 * @property stringSTRONGLY RECOMMENDED $verification_value Security code or CVV, 3-4 digits STRONGLY RECOMMENDED
 * @property stringSTRONGLY RECOMMENDED $ip_address Customer's IP address when updating their Billing Information STRONGLY RECOMMENDED
 */
